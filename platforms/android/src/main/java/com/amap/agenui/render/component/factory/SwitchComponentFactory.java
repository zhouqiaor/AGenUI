...
import com.amap.agenui.render.component.impl.SwitchComponent;

/**
 * Factory for SwitchComponent.
 * Registered via @BuiltInComponent annotation at compile time.
 */
@BuiltInComponent("Switch")
public class SwitchComponentFactory implements com.amap.agenui.render.component.factory.IComponentFactory {
    ...
    public A2UIComponent createComponent(Context context, String componentId,
        ...
        return new SwitchComponent(context, componentId, componentType,
