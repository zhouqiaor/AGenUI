...
import com.amap.agenui.render.component.impl.BadgeComponent;

@BuiltInComponent("Badge")
public class BadgeComponentFactory implements IComponentFactory {
    @Override
    public A2UIComponent createComponent(Context context, String componentId,
                                         String componentType,
                                         ComponentEventDispatcher eventDispatcher,
                                         ComponentState componentState) {
        return new BadgeComponent(context, componentId, componentType,
