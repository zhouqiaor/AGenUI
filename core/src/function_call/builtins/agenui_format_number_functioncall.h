...
/**
 * @brief FormatNumber functionCall — formats a number with optional thousands grouping and decimal precision
 */
class FormatNumberFunctionCall : public IFunctionCall {
public:
