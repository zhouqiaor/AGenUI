...
/**
 * @brief Required validation functionCall
 *
 * Checks that a value is non-empty (not null, undefined, or an empty string/array/object).
 */
class RequiredFunctionCall : public IFunctionCall {
public:
